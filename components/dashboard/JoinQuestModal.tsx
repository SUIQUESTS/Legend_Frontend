...
interface JoinQuestModalProps {
    ...
    isOpen: boolean;
    onClose: () => void;
    onSubmit: (questId: number, link: string) => void;
}
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="mt-8 space-y-6">
                    ...
                    <button
                        ...
                        className="w-full group relative font-bold text-lg text-primary px-8 py-3 bg-accent rounded-lg focus:outline-none focus:ring-4 focus:ring-accent/50 transition-all duration-300 transform hover:scale-105 hover:shadow-glow-accent disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        ...
                        <span className="relative z-10">{isSubmitting ? 'Submitting...' : 'Submit & Join Quest'}</span>
                    </button>
                </form>
            </div>
        </div>
