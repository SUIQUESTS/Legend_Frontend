...
const AchievementCard: React.FC<AchievementCardProps> = ({ achievement, index, isVisible }) => {
    ...
    return (
        ...
        >
            ...
            <img src={achievement.image} alt={achievement.name} className="absolute inset-0 w-full h-full object-cover transition-transform duration-300 group-hover:scale-110" />
            ...
            <div className="relative z-10 p-4 flex flex-col justify-end h-full">
                <div className="transform-gpu transition-transform duration-300 ease-in-out group-hover:-translate-y-2">
                     <h3 className="text-lg font-bold font-heading text-primary leading-tight line-clamp-2">{achievement.name}</h3>
                </div>
